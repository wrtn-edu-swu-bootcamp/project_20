...
**4. 브랜드 인식 및 Tier 시스템** ⭐ **핵심 차별화 기능**
- **OCR 기반 브랜드 자동 인식**: Google Vision API Text Detection 활용
- **100+ 글로벌/국내 브랜드 데이터베이스**:
  - Premium: GUCCI, CHANEL, Supreme, BAPE, Vivienne Westwood 등
  - Popular: ARCTERYX, 아더에러, 무신사, Stussy, Carhartt 등
  - Sports: NIKE, ADIDAS, New Balance, PUMA 등
  - Basic: ZARA, H&M, UNIQLO, SPAO 등
- **브랜드 수동 입력/수정 기능**:
  - AI 인식 실패 시 사용자가 직접 입력 가능
  - 자동완성 지원 (실시간 검색)
  - 브랜드 변경 시 추천 경로 자동 재계산
- **실제 중고거래 시장 데이터 반영**:
  - 후루츠 패밀리, 번개장터 인기 브랜드 데이터 기반
  - 브랜드 Tier별 플랫폼 매칭
  - 명품은 상태와 무관하게 재판매 가치 높음
...
**경로 1: 재판매 (중고 플랫폼)** - **브랜드 Tier 기반 스마트 매칭**
- **적합 조건**: S~B등급 (Premium 브랜드는 C등급까지)
- **예상 판매가**: 브랜드 Tier 및 등급 기반 동적 계산
  - Premium/S등급: 100,000~500,000원 (구찌, 샤넬 등)
  - Popular/S등급: 50,000~150,000원 (아크테릭스, 아더에러 등)
  - Sports/S등급: 30,000~100,000원 (나이키, 아디다스 등)
  - Basic/S등급: 15,000~35,000원 (자라, 유니클로 등)
- **추천 플랫폼 (브랜드 Tier별 자동 매칭)**:
  - **Premium Tier** → 후루츠 패밀리, 크림, 발란, 머스트잇
  - **Popular Tier** → 번개장터, 당근마켓, 중고나라, 후루츠 패밀리
  - **Sports Tier** → 번개장터, 당근마켓, 크림, 솔드아웃
  - **Basic Tier** → 당근마켓, 번개장터, 중고나라
- **예상 소요 시간**: 등록 5분, 판매 1주~1개월
- **환경 기여도**: CO2 3.0~3.5kg 절감 (재판매 방법에 따라 동적 계산)
...
- **환경 기여도**: CO2 2.5kg 절감 (처리 방법 기반 동적 계산)
...
- **연계 업체**:
  ...
  - 로컬 리폼샵 (지역별 안내)
- **예상 비용/수익**: 벌당 3,000~10,000원 (상태 및 소재 기반)
- **예상 소요 시간**: 상담 후 결정
- **환경 기여도**: CO2 4.0kg 절감 (최고 친환경! 새 제품 제작 대비)
...
- **예상 소요 시간**: 수거함 방문 10분
- **환경 기여도**: CO2 1.5kg, 물 1,350L 절감 (섬유 재생은 부분 절약)

**경로 5: 렌탈 서비스 원료**
- **적합 조건**: A~B등급, 유행 타지 않는 베이직 아이템
- **연계 서비스**:
  - 의류 렌탈 업체
- **예상 수익**: 벌당 3,000~10,000원 (등급 기반)
- **예상 소요 시간**: 택배 발송
- **환경 기여도**: CO2 3.5kg 절감 (공유경제 활성화)
